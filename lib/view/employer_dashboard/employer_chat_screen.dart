...
import 'package:stay_job_vendor/controller/employer_dashboard/employer_chat_screen_controller.dart';
...
class EmployerChatScreen extends StatelessWidget {
  final EmployerChatScreenController controller = Get.put(
    EmployerChatScreenController(),
  );
  EmployerChatScreen({super.key});
